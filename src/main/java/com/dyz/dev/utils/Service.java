...
public interface Service<T> {
  ...
  T findByStringId(String id); // id为String类型的时候

  public void deleteByStringId(String id); // id为String类型的时候
  ...
  void saveAndUpdate(T t) throws IntrospectionException, IllegalAccessException;
